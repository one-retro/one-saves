// @generated by `cargo xtask sync-registries` from ../data/*.json. Do not edit by hand.
//
// The JSON under `data/` is itself synced from the registry pages at docs.1retro.com, so a
// change starts there, lands in the JSON, and reaches this file last.
